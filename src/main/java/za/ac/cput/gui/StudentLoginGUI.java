...
public class StudentLoginGUI extends JPanel {
    ...
    public StudentLoginGUI() {
        ...
        lblloginHeader = new JLabel ("newLabel");
        lblSubHeader = new JLabel ("newLabel");
        lblEmailAddress = new JLabel ("newLabel");
        txtEmail = new JTextField (5);
        lblPassword = new JLabel ("newLabel");
        tstPassword = new JTextField (5);
        btnLogin = new JButton ("newButton");
        lblRegister = new JLabel ("newLabel");
        btnRegister = new JButton ("newButton");
        lblEmailErr = new JLabel ("newLabel");
        lblPasswordErr = new JLabel ("newLabel");
