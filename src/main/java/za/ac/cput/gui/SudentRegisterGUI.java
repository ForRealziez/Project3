 ...
 * Project assignment
 */
public class SudentRegisterGUI extends JPanel implements ActionListener{
    ...
    public SudentRegisterGUI(){
       //construct preComponents
        ...
        //set component bounds (Changes will be made)
    ...
    public static void main(String[] args) {
        ...
        frame.getContentPane().add (new SudentRegisterGUI());
        frame.pack();
